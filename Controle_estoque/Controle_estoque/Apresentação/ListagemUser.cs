...
{
    public partial class ListagemUser : Form
    {
        ...
        private void ListagemUser_Load(object sender, EventArgs e)
        {
        ...
        public void list()
        {
            ...
            listView1.Columns.Add("Data_Cadastro", 130, HorizontalAlignment.Center);
            cont = 0;
        ...
        //Escolhe uma linha para gerar etiqueta
        private void listView1_Click(object sender, EventArgs e)
        {
            Variaveis.id_produto = Convert.ToInt32(listView1.SelectedItems[0].SubItems[1].Text);
            numericUpDown1.Text = listView1.SelectedItems[0].SubItems[8].Text;
        }

        //Adiciona quantidade atual ao produto
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            SqlCommand cmd = new SqlCommand("UPDATE produto SET qtdatual = @qtdatual WHERE id = @id;", con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.AddWithValue("@qtdatual", numericUpDown1.Value);
